    ...
    public class GetCalendarTests
    {
        ...
        public async Task GivenCompleteRequest_WhenGetCalendar_ThenAGetReturnsTheCalculatedCalendar()
        {
            ...
            using (var getCalendarResponse = await _client.GetAsync($"/api/v1/calendar?rentalId={postRentalResult.Id}&start=2000-01-01&nights=5"))
            {
                ...
                Assert.Contains(getCalendarResult.Dates[3].PreparationTimes, preparationTime => preparationTime.Unit == 1);
                ...
                Assert.Contains(getCalendarResult.Dates[4].PreparationTimes, preparationTime => preparationTime.Unit == 1);
                Assert.Contains(getCalendarResult.Dates[4].PreparationTimes, preparationTime => preparationTime.Unit == 2);
            }
        }
    }
}
